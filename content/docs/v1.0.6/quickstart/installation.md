...
{{% tab name="Windows" %}}
  The simplest way to install Plakar on Windows is by downloading the pre-built package from the [Download page](/download/v1.0.6).
...
{{% tab name="Others" %}}
  ...
  For other supported operating systems, or for an alternative to the methods mentioned above, it is possible to download pre-built binaries for different platforms and architectures from the [Download page](/download/v1.0.6).
...
All release versions of **plakar** are available directly from GitHub on the project's [release page](/download/v1.0.6).
