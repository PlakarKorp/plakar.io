...
<section class="Ss">
<h2 class="Ss" id="General_Commands"><a class="permalink" href="#General_Commands">General
  Commands</a></h2>
<dl class="Bl-tag">
  ...
  <dd>Manage additional Plakar services that require you to be logged in, refer
      to <a class="Xr" href="../plakar-service/">plakar-service(1)</a>.</dd>
  ...
  <dd>Generate a token to interact with Plakar services, refer to
      <a class="Xr" href="../plakar-token-create/">plakar-token-create(1)</a>.</dd>
...
<section class="Ss">
<h2 class="Ss" id="Kloset_management"><a class="permalink" href="#Kloset_management">Kloset
  management</a></h2>
<dl class="Bl-tag">
  ...
  <dd>Prune snapshots according to a policy, refer to
      <a class="Xr" href="../plakar-prune/">plakar-prune(1)</a>.</dd>
...
<section class="Ss">
<h2 class="Ss" id="Snapshot_management"><a class="permalink" href="#Snapshot_management">Snapshot
  management</a></h2>
<dl class="Bl-tag Bl-compact">
  ...
  <dd>Duplicate an existing snapshot with a different ID, refer to
      <a class="Xr" href="../plakar-dup/">plakar-dup(1)</a>.</dd>
...
<section class="Ss">
<h2 class="Ss" id="Plugin_handling"><a class="permalink" href="#Plugin_handling">Plugin
  handling</a></h2>
<dl class="Bl-tag">
  ...
  <dd>List installed plugins, refer to
      <a class="Xr" href="../plakar-pkg-show/">plakar-pkg-show(1)</a>.</dd>
</dl>
</section>
</section>
<section class="Sh">
...
<p class="Pp">The following exit codes are aligned with
    <a class="Xr" href="../sysexits/">sysexits(3)</a> where applicable:</p>
<dl class="Bl-tag">
  <dt>0</dt>
