...
<<<<<<< HEAD Create a configuration for your Kloset store. This ensures the
scheduler can later retrieve the store passphrase: =======
...
> > > > > > > da7f27214d (update scheduling doc for v1.1.x and latest)
