...
weight: 4
summary:
  "Understand why multiple backup copies drastically reduce the risk of data
  loss, and how this leads to the 3‑2‑1 backup strategy."
aliases:
  - /docs/v1.0.6/explanations/why-several-copies/
  - /docs/v1.0.6/guides/why-several-copies
---
