...
aliases:
  - /docs/v1.0.5/integrations/koofr/
---

# Koofr

The Koofr integration package for Plakar allows you to back up and restore data to and from Koofr, as well as host Kloset stores directly within Koofr. It is built on top of [Rclone](https://rclone.org/), a command-line tool for managing cloud storage backends.
...
3. Enter the number corresponding to "Koofr" from the list of supported storage providers.
4. Enter your email and your app password. If you don't have an **app password**, generate one in your [Koofr account settings](https://app.koofr.net/app/admin/preferences/password).
