...
weight: 6
summary:
  "Understand how Plakar stores backup data in chunks and packfiles, why
  deleting a snapshot does not immediately free space, and how the maintenance
  process safely reclaims unused storage."
aliases:
  - /docs/v1.0.5/explanations/how-maintenance-works/
---
...
Marked chunks remain in the store for a grace period, currently set to 30 days.
