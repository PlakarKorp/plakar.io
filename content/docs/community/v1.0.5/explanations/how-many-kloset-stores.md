...
weight: 3
summary:
  "Understand how deduplication, data similarity, and security requirements
  affect the number of Kloset Stores you should use."
aliases:
  - /docs/v1.0.5/explanations/how-many-kloset-stores/
  - /docs/v1.0.5/guides/how-many-kloset-stores
---
