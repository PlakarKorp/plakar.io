...
aliases:
  - /docs/v1.0.5/references/commands/plakar-source/
  - /docs/v1.0.5/commands/plakar-source/
---
...
<dl class="Bl-tag">
  ...
  <dd>Import source configurations from various sources including files, piped
    ...
    <p class="Pp">For detailed examples and usage patterns, see the
        <a class="Lk" href="https://plakar.io/docs/v1.0.5/guides/importing-configurations/">https://plakar.io/docs/v1.0.5/guides/importing-configurations/</a>
