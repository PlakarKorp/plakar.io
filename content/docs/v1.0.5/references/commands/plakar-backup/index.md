...
aliases:
  - /docs/v1.0.5/commands/plakar-backup/
---
...
<table class="Nm">
  <tr>
    ...
    <td>[<code class="Fl">-concurrency</code> <var class="Ar">number</var>]
      ...
      <var class="Ar">path</var>] [<code class="Fl">-post-hook</code>
      <var class="Ar">command</var>] [<code class="Fl">-pre-hook</code>
      <var class="Ar">command</var>] [<code class="Fl">-quiet</code>]
...
<dl class="Bl-tag">
  ...
  <dd>Execute <var class="Ar">command</var> after a successful backup.</dd>
  <dt id="pre-hook"><a class="permalink" href="#pre-hook"><code class="Fl">-pre-hook</code></a>
    <var class="Ar">command</var></dt>
  <dd>Execute <var class="Ar">command</var> before the backup.</dd>
...
<div class="foot" role="doc-pagefooter" aria-label="Manual footer
  line"><span class="foot-left">Plakar</span> <span class="foot-date">October
  13, 2025</span> <span class="foot-right">PLAKAR-BACKUP(1)</span></div>
