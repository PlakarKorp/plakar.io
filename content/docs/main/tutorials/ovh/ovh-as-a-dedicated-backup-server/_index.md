...
To back up your source servers, you need to configure SSH access from your backup VPS.
...
Now you'll configure which directories to back up from each source server.
...
```
This configuration:
- Defines three backup tasks (one for each source)
