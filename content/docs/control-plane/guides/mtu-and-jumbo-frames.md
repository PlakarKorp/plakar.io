...
weight: 9
summary:
  "Background on Ethernet MTU, jumbo frames, and TCP MSS, and why they matter
  for control plane deployments."
---
...
[settings](../administration/general-settings) page if your network requires a
different value.
