...
Edges belong to a single organization. You work only with the edges of the
...
Edge enrollment is configured per organization and is disabled by default.

To enable enrollment:

1. Open **Settings**.
2. Select the **Organizations** tab, then select the organization the edges
   should join.
3. Open its **Settings** tab.
4. Under **Edge enrollment**, click **Configure**.
5. Enable enrollment.
