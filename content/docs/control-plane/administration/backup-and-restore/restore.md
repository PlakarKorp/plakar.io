...
weight: 2
summary: "How to restore Plakar Control Plane from a backup snapshot to a new appliance."
---
...
Deploy a new Plakar Control Plane virtual appliance and leave it in **bootstrap mode** without completing the initial setup wizard. Refer to the [installation guide](../../../intro/installation) for platform-specific instructions on deploying the appliance.
...
On the new appliance, install the Plakar OSS client. Refer to the [installation guide](/docs/main/quickstart/installation) for instructions.

Once installed, configure the store where your backup snapshot is hosted. Refer to the [quickstart guide](/docs/main/quickstart/first-backup) for store configuration instructions.
