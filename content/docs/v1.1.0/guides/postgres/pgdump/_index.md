...
description: Back up PostgreSQL databases using the Plakar PostgreSQL integration and restore them.
...
{{% notice style="info" title="Managed services (RDS, Cloud SQL, etc.)" expanded="true" %}}
