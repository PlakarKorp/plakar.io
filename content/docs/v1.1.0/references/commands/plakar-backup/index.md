...
aliases:
  - /docs/v1.1.0/commands/plakar-backup/
---
<table class="head">
  <tr>
...
<table class="Nm">
  <tr>
    ...
    <td>[<code class="Fl">-force-timestamp</code>
      <var class="Ar">timestamp</var>] [<code class="Fl">-ignore</code>
      <var class="Ar">pattern</var>] [<code class="Fl">-ignore-file</code>
      <var class="Ar">file</var>] [<code class="Fl">-check</code>]
      [<code class="Fl">-dry-run</code>] [<code class="Fl">-no-xattr</code>]
