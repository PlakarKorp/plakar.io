...
description: >
  ...
  misconfiguration. Plakar provides encrypted, deduplicated snapshots using
  either logical or physical backups, restorable to any environment.
...
technology_description: >
  ...
  Replication spreads data across nodes which also spreads corruption and
  accidental deletions just as quickly.
