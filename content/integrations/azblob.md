...
subtitle: Encrypted, deduplicated backups for Azure Blob Storage containers

description: >
  Protect your Azure Blob Storage containers against accidental deletion,
  ransomware, and misconfiguration. Plakar provides immutable, encrypted
  snapshots for Azure Blob Storage, restorable across any provider or
  environment.

technology_title:
  Azure Blob Storage is durable, but durability is not protection

technology_description: >
  Azure Blob Storage is a cornerstone of modern cloud infrastructure, used to
  store everything from application assets and log archives to datasets and
  backups. While Azure provides high infrastructure durability, it offers no
  ...
  deduplication, and independent immutability on top of Azure Blob Storage,
