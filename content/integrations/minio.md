...
description: >
  ...
  corruption, and ransomware. Immutable, encrypted, and restorable even offline
  and across environments.

technology_title: MinIO is everywhere and often underprotected

technology_description: >
  MinIO is widely adopted as a high-performance, S3-compatible object storage
  solution, trusted to store logs, datasets, backups, and application data
  across cloud-native and AI/ML environments.

  But MinIO alone does not provide immutability, integrity verification, or
  portable backups.

  Plakar fills that gap by turning MinIO into both a secure backup source and a
