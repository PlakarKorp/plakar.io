...
- [Scheduling Backups](https://plakar.io/docs/community/v1.1.0/guides/setup-scheduler-daily-backups/index.md): Automate Plakar backups with your operating system&rsquo;s native scheduler: cron, systemd timers, launchd, or Windows Task Scheduler.
...
- [Managing passphrases](https://plakar.io/docs/community/v1.1.0/guides/managing-passphrases/index.md): How Kloset store passphrases work in Plakar and how to change the passphrase used by a Kloset store.
...
- [OCI Registry](https://plakar.io/docs/community/v1.1.0/integrations/oci/index.md): Use an OCI registry as a Kloset store backend with Plakar.
- [WebDAV](https://plakar.io/docs/community/v1.1.0/integrations/webdav/index.md): Back up and restore WebDAV remotes with Plakar.
- [CalDAV](https://plakar.io/docs/community/v1.1.0/integrations/caldav/index.md): Back up and restore CalDAV calendars with Plakar.
- [TAR](https://plakar.io/docs/community/v1.1.0/integrations/tar/index.md): Import TAR archives into a Kloset store with Plakar.
- [STDIO](https://plakar.io/docs/community/v1.1.0/integrations/stdio/index.md): Back up from stdin and restore to stdout or stderr with Plakar.
