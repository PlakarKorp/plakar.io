...
## [Scheduled Tasks](https://www.stg.plakar.io/docs/control-plane/scheduling/tasks/index.md)



## [One-off Tasks](https://www.stg.plakar.io/docs/control-plane/scheduling/one-off-tasks/index.md)



## [Manual Scheduler](https://www.stg.plakar.io/docs/control-plane/scheduling/manual-scheduler/index.md)



## [Policy Scheduler](https://www.stg.plakar.io/docs/control-plane/scheduling/policy-scheduler/index.md)



## [User Schedulers](https://www.stg.plakar.io/docs/control-plane/scheduling/user-schedulers/index.md)



## [Job History](https://www.stg.plakar.io/docs/control-plane/scheduling/job-history/index.md)
