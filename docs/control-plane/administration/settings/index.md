...
## [Control Plane Settings](https://www.stg.plakar.io/docs/control-plane/administration/settings/control-plane/index.md)



## [Organization Settings](https://www.stg.plakar.io/docs/control-plane/administration/settings/organization/index.md)
