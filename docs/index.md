...
- [Apps](https://plakar.io/docs/control-plane/apps/index.md): How apps work in Plakar Control Plane and how to configure them.
...
- [Plakar: v1.1.x (latest: v1.1.4)](https://plakar.io/docs/community/v1.1.0/index.md): Plakar documentation hub, find guides, references, and resources for working with Plakar.
