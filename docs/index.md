...
## [Control Plane Docs](https://plakar.io/docs/control-plane/index.md)

- [Getting Started](https://plakar.io/docs/control-plane/intro/index.md): Overview, installation, enrollment, and billing for Plakar Control Plane.
- [Infrastructure](https://plakar.io/docs/control-plane/infrastructure/index.md): Configure and manage inventories and secret providers used by Plakar Control Plane.
- [Connectors](https://plakar.io/docs/control-plane/connectors/index.md): How connectors work in Plakar Control Plane and how to configure them.
- [Resources](https://plakar.io/docs/control-plane/resources/index.md): Resources are the systems and storage targets that Plakar Control Plane backs up, stores data in, or restores to. Learn how to configure each resource type and manage resource settings.
...
- [Plakar: v1.1.3](https://plakar.io/docs/community/v1.1.0/index.md): Plakar documentation hub, find guides, references, and resources for working with Plakar.
